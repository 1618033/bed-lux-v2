...
BLE_NOTIFICATION_UUID = const('6f300200-6c13-464f-a152-f24a4a1d47f5')
...
BLEC_CMD_SET_LIGHT_STATE = const(0x02)
BLEC_CMD_SETCFG = const(0x03)

BLEC_SUBCMD_SYSTEM_RESET = 0x00
BLEC_SUBCMD_SYSTEM_TURN_OFF_WIRELESS = 0xFF
