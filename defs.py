...
BLE_CFG_DIMMER_LEVEL_UUID = const('6f300100-6c13-464f-a152-f24a4a1d47f5')
BLE_CFG_HOSTNAME_UUID = const('6f300101-6c13-464f-a152-f24a4a1d47f5')
BLE_CFG_LIGHT_ON_TIME_UUID = const('6f300102-6c13-464f-a152-f24a4a1d47f5')
...
BLEC_CMD_CONTROL_DIMMER = const(0x01)
BLEC_CMD_SETCFG_DIMMER_LEVEL = const(0x02)
BLEC_CMD_SETCFG_HOSTNAME = const(0x03)
BLEC_CMD_SETCFG_LIGHT_ON_TIME = const(0x04)
BLEC_CMD_ENTER_PROGRAM_MODE = const(0x05)
BLEC_CMD_TOGGLE_SLEEP_MODE = const(0x06)

BLEC_CHARACTERISTIC_DIMMER_LEVEL = const(0x00)
BLEC_CHARACTERISTIC_HOSTNAME = const(0x01)
BLEC_CHARACTERISTIC_LIGHT_ON_TIME = const(0x02)
